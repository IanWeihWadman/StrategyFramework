...
std::make_tuple( #Name, Editor::Reflection::AccessorDescription( []( auto& obj ){ return std::ref( obj.Name ); }, __VA_ARGS__ ) )

#define ACCESSOR_NAME( DisplayName, Name, ... ) \
std::make_tuple( #DisplayName, Editor::Reflection::AccessorDescription( []( auto& obj ){ return std::ref( obj.Name ); }, __VA_ARGS__ ) )
