...
namespace Strategy
{
	...
	struct Serializer<T>
	{
		...
		void Write( Document::Document& doc, std::string_view name, const T& range, Document::NodeHandle parent, auto recursiveWriter ) const
		{
		...
		void Read( T& obj, const Document::Document& doc, Document::Document::Iterator& it, auto recursiveReader ) const
		{
	...
	struct Serializer<T>
	{
		...
		void Write( Document::Document& doc, std::string_view name, const T& obj, Document::NodeHandle parent, auto recursiveWriter ) const
		{
	...
	struct Serializer<std::variant<Alts...>>
	{
		...
		void Write( Document::Document& doc, std::string_view name, const std::variant<Alts...>& obj, Document::NodeHandle parent, auto recursiveWriter ) const
		{
			auto objRoot = doc.EmplaceObjectNode( parent, name );
		...
		void Read( std::variant<Alts...>& obj, const Document::Document& doc, Document::Document::Iterator& it, auto recursiveReader ) const
		{
			it++;
			size_t index = *Document::FromPrimitive<size_t>( std::get<Document::Property>( *it++ ).value );
	...
	struct Serializer<std::optional<T>>
	{
		...
		void Write( Document::Document& doc, std::string_view name, const std::optional<T>& obj, Document::NodeHandle parent, auto recursiveWriter ) const
		{
			auto objRoot = doc.EmplaceObjectNode( parent, name );
		...
		void Read( std::optional<T>& obj, const Document::Document& doc, Document::Document::Iterator& it, auto recursiveReader ) const
		{
			it++;
			bool hasValue = *Document::FromPrimitive<bool>( std::get<Document::Property>( *it++ ).value );
	...
	struct Serializer<std::unique_ptr<T>>
	{
		...
		void Write( Document::Document& doc, std::string_view name, const std::unique_ptr<T>& obj, Document::NodeHandle parent, auto recursiveWriter ) const
		{
			recursiveWriter( doc, name, *obj, parent );
		}

		void Read( std::unique_ptr<T>& obj, const Document::Document& doc, Document::Document::Iterator& it, auto recursiveReader ) const
		{
